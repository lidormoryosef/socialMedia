    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikesToPost", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LikesToPost_Posts_IdPost",
                        column: x => x.IdPost,
                        principalTable: "Posts",
                        principalColumn: "IdPost",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikesToComment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LikesToComment_Comments_IdComment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LikesToComment_IdComment",
                table: "LikesToComment",
                column: "IdComment");

            migrationBuilder.CreateIndex(
                name: "IX_LikesToPost_IdPost",
                table: "LikesToPost",
                column: "IdPost");
        }
